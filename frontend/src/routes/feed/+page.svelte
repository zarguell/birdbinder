                    ...
                    <div class="mt-3 flex items-center gap-4 border-t border-gray-800 pt-3">
                        ...
                        >
                            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 20.25c4.97-4.97 7.5-7.5 7.5-10.5A5.25 5.25 0 0014.25 4.5c-1.68 0-3.17.78-4.25 2-1.08-1.22-2.57-2-4.25-2A5.25 5.25 0 00.75 9.75c0 3 2.53 5.53 7.5 10.5L12 20.25z" />
                            </svg>
